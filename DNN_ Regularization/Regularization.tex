...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    ...
    \PY{c+c1}{\PYZsh{}(≈ 1 lines of code)}
    \PY{c+c1}{\PYZsh{} dW3 = 1./m * np.dot(dZ3, A2.T) + None}
    \PY{c+c1}{\PYZsh{} YOUR CODE STARTS HERE}
    \PY{n}{dW3} \PY{o}{=} \PY{l+m+mf}{1.} \PY{o}{/} \PY{n}{m} \PY{o}{*} \PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{dZ3}\PY{p}{,} \PY{n}{A2}\PY{o}{.}\PY{n}{T}\PY{p}{)} \PY{o}{+} \PY{p}{(}\PY{n}{lambd} \PY{o}{/} \PY{n}{m}\PY{p}{)} \PY{o}{*} \PY{n}{W3}
    ...
    \PY{c+c1}{\PYZsh{}(≈ 1 lines of code)}
    \PY{c+c1}{\PYZsh{} dW2 = 1./m * np.dot(dZ2, A1.T) + None}
    \PY{c+c1}{\PYZsh{} YOUR CODE STARTS HERE}
    \PY{n}{dW2} \PY{o}{=} \PY{l+m+mf}{1.}\PY{o}{/}\PY{n}{m} \PY{o}{*} \PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{dZ2}\PY{p}{,} \PY{n}{A1}\PY{o}{.}\PY{n}{T}\PY{p}{)} \PY{o}{+} \PY{p}{(}\PY{n}{lambd} \PY{o}{/} \PY{n}{m}\PY{p}{)} \PY{o}{*} \PY{n}{W2}
    ...
    \PY{c+c1}{\PYZsh{}(≈ 1 lines of code)}
    \PY{c+c1}{\PYZsh{} dW1 = 1./m * np.dot(dZ1, X.T) + None}
    \PY{c+c1}{\PYZsh{} YOUR CODE STARTS HERE}
    \PY{n}{dW1} \PY{o}{=} \PY{l+m+mf}{1.}\PY{o}{/}\PY{n}{m} \PY{o}{*} \PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{dZ1}\PY{p}{,} \PY{n}{X}\PY{o}{.}\PY{n}{T}\PY{p}{)} \PY{o}{+} \PY{p}{(}\PY{n}{lambd} \PY{o}{/} \PY{n}{m}\PY{p}{)} \PY{o}{*} \PY{n}{W1}
...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    ...
    \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} START CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} (approx. 4 lines)         \PYZsh{} Steps 1\PYZhy{}4 below correspond to the Steps 1\PYZhy{}4 described above.}
    \PY{n}{D1} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{random}\PY{o}{.}\PY{n}{rand}\PY{p}{(}\PY{n}{A1}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{A1}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}  \PY{c+c1}{\PYZsh{} Step 1: initialize matrix D1 = np.random.rand(..., ...)}
    \PY{n}{D1} \PY{o}{=} \PY{p}{(}\PY{n}{D1} \PY{o}{\PYZlt{}} \PY{n}{keep\PYZus{}prob}\PY{p}{)}  \PY{c+c1}{\PYZsh{} Step 2: convert entries of D1 to 0 or 1 (using keep\PYZus{}prob as the threshold)}
    \PY{n}{A1} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{multiply}\PY{p}{(}\PY{n}{A1}\PY{p}{,} \PY{n}{D1}\PY{p}{)}  \PY{c+c1}{\PYZsh{} Step 3: shut down some neurons of A1}
    \PY{n}{A1} \PY{o}{=} \PY{n}{A1} \PY{o}{/} \PY{n}{keep\PYZus{}prob}  \PY{c+c1}{\PYZsh{} Step 4: scale the value of neurons that haven\PYZsq{}t been shut down}
    ...
    \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} START CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} (approx. 4 lines)}
    \PY{n}{D2} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{random}\PY{o}{.}\PY{n}{rand}\PY{p}{(}\PY{n}{A2}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{A2}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}  \PY{c+c1}{\PYZsh{} Step 1: initialize matrix D2 = np.random.rand(..., ...)}
    \PY{n}{D2} \PY{o}{=} \PY{p}{(}\PY{n}{D2} \PY{o}{\PYZlt{}} \PY{n}{keep\PYZus{}prob}\PY{p}{)}  \PY{c+c1}{\PYZsh{} Step 2: convert entries of D2 to 0 or 1 (using keep\PYZus{}prob as the threshold)}
    \PY{n}{A2} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{multiply}\PY{p}{(}\PY{n}{D2}\PY{p}{,} \PY{n}{A2}\PY{p}{)}  \PY{c+c1}{\PYZsh{} Step 3: shut down some neurons of A2}
    \PY{n}{A2} \PY{o}{=} \PY{n}{A2} \PY{o}{/} \PY{n}{keep\PYZus{}prob}  \PY{c+c1}{\PYZsh{} Step 4: scale the value of neurons that haven\PYZsq{}t been shut down}
    \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} END CODE HERE \PYZsh{}\PYZsh{}\PYZsh{}}
...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    ...
    \PY{n}{dA2} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{multiply}\PY{p}{(}\PY{n}{dA2}\PY{p}{,} \PY{n}{D2}\PY{p}{)}    \PY{c+c1}{\PYZsh{} Step 1: Apply mask D2 to shut down the same neurons as during the forward propagation}
    \PY{n}{dA2} \PY{o}{=} \PY{n}{dA2}\PY{o}{/}\PY{n}{keep\PYZus{}prob}           \PY{c+c1}{\PYZsh{} Step 2: Scale the value of neurons that haven\PYZsq{}t been shut down}
    ...
    \PY{n}{dA1} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{multiply}\PY{p}{(}\PY{n}{dA1}\PY{p}{,} \PY{n}{D1}\PY{p}{)}    \PY{c+c1}{\PYZsh{} Step 1: Apply mask D1 to shut down the same neurons as during the forward propagation}
    \PY{n}{dA1} \PY{o}{=} \PY{n}{dA1}\PY{o}{/}\PY{n}{keep\PYZus{}prob}           \PY{c+c1}{\PYZsh{} Step 2: Scale the value of neurons that haven\PYZsq{}t been shut down}
